...
export class QmeupKioskCreation {
    ...
    constructor (page: any){
        ...
        this.buttonaddkiosk = page.locator('//html/body/div[1]/div/div[2]/div/div[2]/div/div[2]/div/div/div[1]/section[1]/div[2]/div/button');
