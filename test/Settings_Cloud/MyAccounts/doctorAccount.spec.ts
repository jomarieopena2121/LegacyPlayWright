...
import { fillupAllInfoMale, uploadProfilePhoto, genderMale, 
    ...
    doctorInformation,
    doctorSettings,
} from "../../../QMSFunction/QMS_ONPREM/QmeupMyAccount";
import { PageManager } from "../../../PageObjectModels/MainPageObjectModels";
import { landingPage, pageLogins, doctorsAccount,landingPageCloud } from "../../../QMSFunction/QMS_ONPREM/QmeupLogin";
...
import { dashBoard, Settings, dashBoardDoctor } from "../../../QMSFunction/QMS_ONPREM/QmeupNavigation";
